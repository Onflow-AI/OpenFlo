...
from avenir_ux.agent.config import load_agent_config
from avenir_ux.agent.reporting import (
...
from avenir_ux.agent.evaluation import (
...
from avenir_ux.browser.helper import (
    saveconfig,
    setup_agent_logger,
...
from avenir_ux.prompts.format import (
    format_choices,
    postprocess_action_lmm,
    postprocess_action_lmm_pixel,
)
from avenir_ux.utils.image import (
    take_screenshot,
    annotate_current_screenshot,
    take_full_page_screenshot_with_cropping,
)
from avenir_ux.llm.engine import engine_factory
from avenir_ux.llm.engine import LLM_IO_RECORDS, add_llm_io_record
from avenir_ux.managers.checklist import ChecklistManager
from avenir_ux.utils.reasoning import generate_task_reasoning, format_reasoning_for_prompt
from avenir_ux.browser.dom import (
    extract_typeable_elements,
    extract_selectable_elements,
    choose_field_with_llm,
)
from avenir_ux.browser.recovery import (
    capture_page_state,
...
class AvenirUXAgent:
    def __init__(
        ...
        save_file_dir="avenir_ux_agent_files",
        ...
        if self.ux_synthesis_enabled:
            try:
                from avenir_ux.managers.ux_synthesis import UXSynthesisManager
                ...
                if persona_data:
                    try:
                        from avenir_ux.personas.profile import PersonaProfile
        ...
        if self.ux_synthesis_enabled:
            try:
                from avenir_ux.ux.trajectory_logger import TrajectoryLogger
                from avenir_ux.ux.metrics_evaluator import UXMetricsEvaluator
    ...
    async def _generate_task_reasoning(self):
        ...
        try:
            ...
            allowed_domain = ""
        from avenir_ux.prompts.templates import build_task_constraints_prompt
    ...
    async def _log_trajectory_transition(self, action_data: dict):
        ...
        try:
            from avenir_ux.ux.dom_hasher import hash_dom_state

...
class ChecklistManager:
    ...
    async def generate_task_checklist(self, task_description, strategic_reasoning=""):
        ...
        self.logger.info(f"Query generation attempt {self.query_generation_count}/{self.max_query_generations}")
        ...
        try:
            checklist_prompt = build_checklist_prompt(task_description, strategic_reasoning)
            ...
            try:
                ...
                self.logger.info(f"Generated checklist with {len(self.task_checklist)} items")
